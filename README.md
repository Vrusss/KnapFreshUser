...
## Модуль приложения
	...
	Процедура бит_ПриНачалеРаботыСистемы()  
 ...
 ## бит_Форма
	...
	&НаКлиенте
	Процедура ОткрытьВерсионирование(Команда)  
	...
	// Проверяет по имени существует ли создаваемый пользователь и останавливает дальнейшее выполнение программы если существует
 	// Возвращаемое значение:
  	//	Булево
	&НаСервере
	Функция СоздатьПользователяНаСервере()  
	...
	&НаСервере
	Процедура СоздатьУсловногоПользователя() Экспорт  
	...
	// Записывает или перезаписывает элемент регистра сведений БезопасноеХранилищеДанныхОбластейДанных
 	// Параметры:
	//	Владелец - СправочникСсылка, ПланОбмена, Строка - уникальный идентификатор элемена регистра
 	//	Данные - Структура, Строка - данные для сохранения в регистре
  	//	Ключ - Строка - пароль для доступа к  элементу регистра. По умолчанию имеет значение "Пароль"
	&НаСервере
	Процедура ЗаписатьВОбластьДанных(Владелец, Данные, Ключ = "Пароль")  
	...
	КонецПроцедуры  
	// Включает бессрочное версионирование приведенных объектов  
	&НаСервере
	Процедура ИзменитьВариантВерсионирования()  
	...
	&НаКлиенте
	Процедура ОткрытьФормуВерсионирования()  
	...
	Процедура ПриОткрытии(Отказ)  
		// Вывод диалога ДаНет пользователю, о включении версионирования для приведенных объектов	
	...
	КонецПроцедуры
	// Обработка диалога ДаНет из процедуры ПриОткрытии
	&НаКлиенте
	Процедура ПриОткрытииЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
		
		Ответ = РезультатВопроса;
		// Если ответ диалога = Да, то изменяет верисонирование и включает галочку включения версионирования объектов
